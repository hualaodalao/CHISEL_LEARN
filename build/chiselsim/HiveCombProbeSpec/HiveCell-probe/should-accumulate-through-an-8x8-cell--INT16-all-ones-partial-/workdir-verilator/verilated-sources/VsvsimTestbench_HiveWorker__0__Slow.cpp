...
VL_ATTR_COLD void VsvsimTestbench_HiveWorker___eval_initial__TOP__svsimTestbench__DOT__dut__DOT__pes_0_0(VsvsimTestbench_HiveWorker* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VsvsimTestbench_HiveWorker___eval_initial__TOP__svsimTestbench__DOT__dut__DOT__pes_0_0\n"); );
...
VL_ATTR_COLD void VsvsimTestbench_HiveWorker___eval_initial__TOP__svsimTestbench__DOT__dut__DOT__pes_0_7(VsvsimTestbench_HiveWorker* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VsvsimTestbench_HiveWorker___eval_initial__TOP__svsimTestbench__DOT__dut__DOT__pes_0_7\n"); );
    VsvsimTestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    VlUnpacked<IData/*31:0*/, 3> __PVT__unnamedblk3__DOT___RANDOM;
