...
VsvsimTestbench::VsvsimTestbench(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__svsimTestbench__DOT__dut__DOT__arrays_0_0{vlSymsp->TOP.__PVT__svsimTestbench__DOT__dut__DOT__arrays_0_0}
    , __PVT__svsimTestbench__DOT__dut__DOT__arrays_0_1{vlSymsp->TOP.__PVT__svsimTestbench__DOT__dut__DOT__arrays_0_1}
    , __PVT__svsimTestbench__DOT__dut__DOT__arrays_1_0{vlSymsp->TOP.__PVT__svsimTestbench__DOT__dut__DOT__arrays_1_0}
    , __PVT__svsimTestbench__DOT__dut__DOT__arrays_1_1{vlSymsp->TOP.__PVT__svsimTestbench__DOT__dut__DOT__arrays_1_1}
    , rootp{&(vlSymsp->TOP)}
{
