...
VL_ATTR_COLD void VsvsimTestbench_HiveWorker___eval_initial__TOP__svsimTestbench__DOT__dut__DOT__arrays_0_0__DOT__pes_0_0(VsvsimTestbench_HiveWorker* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VsvsimTestbench_HiveWorker___eval_initial__TOP__svsimTestbench__DOT__dut__DOT__arrays_0_0__DOT__pes_0_0\n"); );
...
VL_ATTR_COLD void VsvsimTestbench_HiveWorker___eval_initial__TOP__svsimTestbench__DOT__dut__DOT__arrays_0_0__DOT__pes_0_7(VsvsimTestbench_HiveWorker* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VsvsimTestbench_HiveWorker___eval_initial__TOP__svsimTestbench__DOT__dut__DOT__arrays_0_0__DOT__pes_0_7\n"); );
    VsvsimTestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    VlUnpacked<IData/*31:0*/, 3> __PVT__unnamedblk3__DOT___RANDOM;
...
VL_ATTR_COLD void VsvsimTestbench_HiveWorker___ctor_var_reset(VsvsimTestbench_HiveWorker* vlSelf) {
    ...
    vlSelf->io_aIn = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 9436503435736357765ull);
    vlSelf->io_aOut = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 2915779943878250693ull);
    vlSelf->io_psumIn = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12372357165803283730ull);
    vlSelf->io_psumOut = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 2417062124076075382ull);
    ...
    vlSelf->io_validOut = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2134219546585533004ull);
