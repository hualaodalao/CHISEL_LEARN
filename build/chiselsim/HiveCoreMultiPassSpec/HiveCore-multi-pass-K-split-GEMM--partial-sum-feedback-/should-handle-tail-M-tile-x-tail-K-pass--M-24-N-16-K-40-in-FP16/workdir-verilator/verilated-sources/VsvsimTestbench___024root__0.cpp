...
void VsvsimTestbench___024root___act_sequent__TOP__0(VsvsimTestbench___024root* vlSelf) {
    ...
    if ((1U == vlSelfRef.svsimTestbench__DOT__simulationState)) {
        VsvsimTestbench___024root____Vdpiimwrap_svsimTestbench__DOT__simulation_body_TOP(
                                                                                ...
                                                                                "/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreMultiPassSpec/HiveCore-multi-pass-K-split-GEMM--partial-sum-feedback-/should-handle-tail-M-tile-x-tail-K-pass--M-24-N-16-K-40-in-FP16/workdir-verilator/../generated-sources/testbench.sv", 0x000002fdU);
...
void VsvsimTestbench___024root___nba_sequent__TOP__0(VsvsimTestbench___024root* vlSelf) {
    ...
    if (((((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT___layerCapture) 
        ...
        if (VL_UNLIKELY(((1U & (~ (IData)(vlSelfRef.svsimTestbench__DOT__reset)))))) {
            ...
            VL_STOP_MT("/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreMultiPassSpec/HiveCore-multi-pass-K-split-GEMM--partial-sum-feedback-/should-handle-tail-M-tile-x-tail-K-pass--M-24-N-16-K-40-in-FP16/workdir-verilator/../primary-sources/verification/assert/HiveCoreExecutor_Verification_Assert.sv", 26, "");
            VL_WRITEF_NX("[%0t] %%Fatal: HiveCoreExecutor_Verification_Assert.sv:28: Assertion failed in %m\n",3, 'M',vlSymsp->name(),"svsimTestbench.dut.executor.verification_assert", 'T',-9
                         , '#',64,VL_TIME_UNITED_Q(10));
            VL_STOP_MT("/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreMultiPassSpec/HiveCore-multi-pass-K-split-GEMM--partial-sum-feedback-/should-handle-tail-M-tile-x-tail-K-pass--M-24-N-16-K-40-in-FP16/workdir-verilator/../primary-sources/verification/assert/HiveCoreExecutor_Verification_Assert.sv", 28, "", false);
        }
    }
    if (((((0U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)) 
        ...
        if (VL_UNLIKELY(((1U & (~ (IData)(vlSelfRef.svsimTestbench__DOT__reset)))))) {
            VL_WRITEF_NX("[%0t] %%Error: HiveCoreExecutor_Verification_Assert.sv:33: Assertion failed in %m: Assertion failed: HiveCoreExecutor: A buffer not drained at execute pulse (previous run aDma push rows != executor consume rows)\n\n",3, 'M',vlSymsp->name(),"svsimTestbench.dut.executor.verification_assert", 'T',-9
                         , '#',64,VL_TIME_UNITED_Q(10));
            VL_STOP_MT("/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreMultiPassSpec/HiveCore-multi-pass-K-split-GEMM--partial-sum-feedback-/should-handle-tail-M-tile-x-tail-K-pass--M-24-N-16-K-40-in-FP16/workdir-verilator/../primary-sources/verification/assert/HiveCoreExecutor_Verification_Assert.sv", 33, "");
            VL_WRITEF_NX("[%0t] %%Fatal: HiveCoreExecutor_Verification_Assert.sv:35: Assertion failed in %m\n",3, 'M',vlSymsp->name(),"svsimTestbench.dut.executor.verification_assert", 'T',-9
                         , '#',64,VL_TIME_UNITED_Q(10));
            VL_STOP_MT("/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreMultiPassSpec/HiveCore-multi-pass-K-split-GEMM--partial-sum-feedback-/should-handle-tail-M-tile-x-tail-K-pass--M-24-N-16-K-40-in-FP16/workdir-verilator/../primary-sources/verification/assert/HiveCoreExecutor_Verification_Assert.sv", 35, "", false);
        }
    }
...
void VsvsimTestbench___024root___eval(VsvsimTestbench___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00002710U < __VicoIterCount)))) {
            ...
            VsvsimTestbench___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreMultiPassSpec/HiveCore-multi-pass-K-split-GEMM--partial-sum-feedback-/should-handle-tail-M-tile-x-tail-K-pass--M-24-N-16-K-40-in-FP16/workdir-verilator/../generated-sources/testbench.sv", 1, "", "DIDNOTCONVERGE: Input combinational region did not converge after '--converge-limit' of 10000 tries");
        }
