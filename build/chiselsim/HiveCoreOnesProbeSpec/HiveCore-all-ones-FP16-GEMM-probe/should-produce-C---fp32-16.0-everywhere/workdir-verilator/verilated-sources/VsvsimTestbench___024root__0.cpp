...
void VsvsimTestbench___024root___act_sequent__TOP__0(VsvsimTestbench___024root* vlSelf) {
    ...
    if ((1U == vlSelfRef.svsimTestbench__DOT__simulationState)) {
        VsvsimTestbench___024root____Vdpiimwrap_svsimTestbench__DOT__simulation_body_TOP(
                                                                                ...
                                                                                "/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreOnesProbeSpec/HiveCore-all-ones-FP16-GEMM-probe/should-produce-C---fp32-16.0-everywhere/workdir-verilator/../generated-sources/testbench.sv", 0x000002fdU);
...
void VsvsimTestbench___024root___nba_sequent__TOP__0(VsvsimTestbench___024root* vlSelf) {
    ...
    if (((((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT___layerCapture) 
        ...
        if (VL_UNLIKELY(((1U & (~ (IData)(vlSelfRef.svsimTestbench__DOT__reset)))))) {
            ...
            VL_STOP_MT("/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreOnesProbeSpec/HiveCore-all-ones-FP16-GEMM-probe/should-produce-C---fp32-16.0-everywhere/workdir-verilator/../primary-sources/verification/assert/HiveCoreExecutor_Verification_Assert.sv", 26, "");
            VL_WRITEF_NX("[%0t] %%Fatal: HiveCoreExecutor_Verification_Assert.sv:28: Assertion failed in %m\n",3, 'M',vlSymsp->name(),"svsimTestbench.dut.executor.verification_assert", 'T',-9
                         , '#',64,VL_TIME_UNITED_Q(10));
            VL_STOP_MT("/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreOnesProbeSpec/HiveCore-all-ones-FP16-GEMM-probe/should-produce-C---fp32-16.0-everywhere/workdir-verilator/../primary-sources/verification/assert/HiveCoreExecutor_Verification_Assert.sv", 28, "", false);
        }
    }
    if (((((0U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)) 
           & (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executePulse)) 
          & (~ (IData)(vlSelfRef.svsimTestbench__DOT__reset))) 
         & (0U != (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT___scratchpad_io_aOccupancy)))) {
        if (VL_UNLIKELY(((1U & (~ (IData)(vlSelfRef.svsimTestbench__DOT__reset)))))) {
            VL_WRITEF_NX("[%0t] %%Error: HiveCoreExecutor_Verification_Assert.sv:33: Assertion failed in %m: Assertion failed: HiveCoreExecutor: A buffer not drained at execute pulse (previous run aDma push rows != executor consume rows)\n\n",3, 'M',vlSymsp->name(),"svsimTestbench.dut.executor.verification_assert", 'T',-9
                         , '#',64,VL_TIME_UNITED_Q(10));
            VL_STOP_MT("/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreOnesProbeSpec/HiveCore-all-ones-FP16-GEMM-probe/should-produce-C---fp32-16.0-everywhere/workdir-verilator/../primary-sources/verification/assert/HiveCoreExecutor_Verification_Assert.sv", 33, "");
            VL_WRITEF_NX("[%0t] %%Fatal: HiveCoreExecutor_Verification_Assert.sv:35: Assertion failed in %m\n",3, 'M',vlSymsp->name(),"svsimTestbench.dut.executor.verification_assert", 'T',-9
                         , '#',64,VL_TIME_UNITED_Q(10));
            VL_STOP_MT("/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreOnesProbeSpec/HiveCore-all-ones-FP16-GEMM-probe/should-produce-C---fp32-16.0-everywhere/workdir-verilator/../primary-sources/verification/assert/HiveCoreExecutor_Verification_Assert.sv", 35, "", false);
        }
    }
    ...
    svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_21 
        = (1U & ((IData)(svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_20) 
                 | (~ ((4U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)) 
                       & (IData)(svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_19)))));
    ...
    if (vlSelfRef.svsimTestbench__DOT__reset) {
        ...
        vlSelfRef.svsimTestbench__DOT__dut__DOT__aDma__DOT__blkTarget = 0U;
        vlSelfRef.svsimTestbench__DOT__dut__DOT__aDma__DOT__aNTileTarget = 0U;
        ...
        vlSelfRef.svsimTestbench__DOT__dut__DOT__bDma__DOT__unnamedblk1__DOT___GEN_14 
            = ((((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__scratchpad__DOT__bFifo__DOT__queue__DOT__do_enq)
                  ? (1U | (((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__bDma__DOT__isAReg)
                             ? (((0x0000ffffU == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__bDma__DOT__rowCnt)) 
                                 & (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__bDma__DOT__unnamedblk1__DOT___GEN_7)) 
                                & (0x0000ffffU == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__bDma__DOT__aNTileCnt)))
        ...
        if (vlSelfRef.svsimTestbench__DOT__dut__DOT__bDma__DOT__unnamedblk1__DOT___GEN_13) {
            ...
            if (vlSelfRef.svsimTestbench__DOT__dut__DOT__bDma__DOT__unnamedblk1__DOT___GEN_8) {
                if ((0x0000ffffU == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__bDma__DOT__aNTileCnt))) {
                    if (vlSelfRef.svsimTestbench__DOT__dut__DOT__executePulse) {
                        __Vdly__svsimTestbench__DOT__dut__DOT__bDma__DOT__curAddr 
                            = vlSelfRef.svsimTestbench__DOT__dut__DOT__bDma__DOT__unnamedblk1__DOT___curAddr_T_3;
                    }
        ...
        if (vlSelfRef.svsimTestbench__DOT__dut__DOT__cDma__DOT__unnamedblk1__DOT___GEN_8) {
            ...
            __Vdly__svsimTestbench__DOT__dut__DOT__cDma__DOT__rowCnt 
                = (0x0000ffffU & ((IData)(1U) + (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__cDma__DOT__rowCnt)));
        }
        ...
        vlSelfRef.svsimTestbench__DOT__dut__DOT__aDma__DOT__unnamedblk1__DOT___GEN_6 
            = ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__aDma__DOT__aKtCnt) 
               == (0x0000ffffU & ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__aDma__DOT__blkTarget) 
                                  - (IData)(1U))));
        vlSelfRef.svsimTestbench__DOT__dut__DOT__aDma__DOT__unnamedblk1__DOT___GEN_7 
            = ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__aDma__DOT__aNTileCnt) 
               == (0x0000ffffU & ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__aDma__DOT__aNTileTarget) 
                                  - (IData)(1U))));
        ...
        if (vlSelfRef.svsimTestbench__DOT__dut__DOT__executePulse) {
            ...
            vlSelfRef.svsimTestbench__DOT__dut__DOT__aDma__DOT__blkTarget 
                = (0x0000ffffU & (((IData)(0x0000000fU) 
                                   + vlSelfRef.svsimTestbench__DOT__dut__DOT__regFile_regs_2) 
                                  >> 4U));
            vlSelfRef.svsimTestbench__DOT__dut__DOT__aDma__DOT__aNTileTarget 
                = (0x0000ffffU & (((IData)(0x0000000fU) 
                                   + vlSelfRef.svsimTestbench__DOT__dut__DOT__regFile_regs_1) 
                                  >> 4U));
        ...
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_28 
            = (((5U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)) 
               ...
               & (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__scratchpad__DOT__cFifo__DOT__queue__DOT__full));
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_29 
            = ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_28) 
               | (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__errState));
        ...
        if ((0U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
            if (vlSelfRef.svsimTestbench__DOT__dut__DOT__executePulse) {
                __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__state = 1U;
            } else if (vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_28) {
                __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__state = 0x0aU;
            }
            __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__errState 
                = ((~ (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executePulse)) 
                   & (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_29));
        } else {
            vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT___GEN_33 
                = ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_28)
                    ? 0x0aU : (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state));
            vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT___GEN_34 
                = (((QData)((IData)((0x00000010U | 
                                     ((0xfffff000U 
                                       & (((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT___GEN_33) 
                                           << 0x0000001cU) 
                                          | (((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT___GEN_33) 
                                              << 0x00000018U) 
                                             | (((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT___GEN_33) 
                                                       ...
                                                       | (((((((IData)(svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_25)
                                                          ...
                                                          | (((((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT___GEN_7)
                                                             ...
                                                             | (((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_30) 
                                                                ...
                                                                | (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT___GEN_33))))))));
            __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__state 
                = (0x0000000fU & (IData)((vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT___GEN_34 
                                          >> (0x0000003fU 
                                              & ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state) 
                                                 << 2U)))));
            __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__errState 
        ...
        if ((1U & (~ ((0U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)) 
            ...
            if ((2U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
                if (vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_31) {
                    __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__counter = 0U;
                }
                ...
                if (svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_19) {
                    __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__counter = 0U;
                }
        ...
        if ((1U & (~ (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT___GEN_10)))) {
            if ((5U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
                if (vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_32) {
                    __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__drainCounter = 0U;
                }
    ...
    if ((0U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
        if (vlSelfRef.svsimTestbench__DOT__dut__DOT__executePulse) {
            vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__curMTile = 0U;
            vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__curNTile = 0U;
            __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__curKTile = 0U;
            __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__doneTiles = 0U;
        }
    } else {
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk5__DOT___GEN_35 
            = ((8U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)) 
               & (IData)(svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_26));
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk5__DOT___GEN_36 
            = (1U & ((~ (IData)(svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_26)) 
                     | (IData)(svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_27)));
        if ((1U & (~ (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT___GEN_3)))) {
            if ((3U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
                if (vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT___GEN_7) {
                    vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__curMTile = 0U;
                }
            } else if ((1U & (~ (((4U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)) 
                                  | (5U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) 
                                 | (6U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)))))) {
                if ((7U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
                    if (svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_25) {
                        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__curMTile 
                            = svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___nextMTile_T;
                    }
                } else if ((8U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
                    if ((1U & (~ (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk5__DOT___GEN_36)))) {
                        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__curMTile = 0U;
                    }
                } else if ((9U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
                    vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__curMTile = 0U;
                }
            }
        }
        if ((1U & (~ (((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT___GEN_17) 
                       | (~ (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk5__DOT___GEN_35))) 
                      | (IData)(svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_27))))) {
            vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__curNTile 
                = svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___nextNTile_T;
        }
        if ((1U & (~ (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT___GEN_17)))) {
            if ((8U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
                if ((1U & (~ (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk5__DOT___GEN_36)))) {
                    __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__curKTile = 0U;
                }
            } else if ((9U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
                __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__curKTile 
                    = (0x0000ffffU & ((IData)(1U) + (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__curKTile)));
            }
        }
        if ((1U & (~ ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT___GEN_17) 
                      | (~ (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk5__DOT___GEN_35)))))) {
    ...
    if ((1U & (~ (IData)(svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_21)))) {
    ...
    if ((1U & (~ ((0U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)) 
                  | (1U != (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)))))) {
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk6__DOT___remainK_T_2 
        ...
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__curTileK 
            = ((0x00000010U < vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk6__DOT___remainK_T_2)
                ? 0x00000010U : (0x0000ffffU & vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk6__DOT___remainK_T_2));
    }
    if ((1U & (~ (IData)(svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_20)))) {
        if ((4U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
            ...
            vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk7__DOT___GEN_37 
                = ((~ (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__scratchpad__DOT__cFifo__DOT__queue__DOT__empty)) 
                   & (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__io_cPop_ready_0));
            if ((5U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
                if (svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_22) {
                    __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__aRegs_0[0U] 
                ...
                } else if (svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_23) {
                    VL_ASSIGN_W(256, __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__aRegs_0, VsvsimTestbench__ConstPool__CONST_h9e67c271_0);
                }
            } else if ((6U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state))) {
                VL_ASSIGN_W(256, __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__aRegs_0, VsvsimTestbench__ConstPool__CONST_h9e67c271_0);
            ...
            if (vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT___GEN_12) {
                if (vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk7__DOT___GEN_37) {
                    __Vdly__svsimTestbench__DOT__dut__DOT__executor__DOT__cpsRegs_0[0U] 
            ...
            if ((((5U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)) 
                 ...
                 & ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk7__DOT___GEN_37) 
                    | (IData)(svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT___GEN_23)))) {
    ...
    if (((0U == (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__state)) 
         & (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executePulse))) {
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk4__DOT___newNTiles_T_3 
        ...
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__nTiles 
            = (0x00000fffU & ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk4__DOT___newNTiles_T_3) 
                              >> 4U));
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk4__DOT___newKTiles_T_3 
        ...
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__kTiles 
            = (0x00000fffU & ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk4__DOT___newKTiles_T_3) 
                              >> 4U));
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk4__DOT___newMTiles_T_3 
        ...
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__mTiles 
            = (0x00000fffU & ((IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk4__DOT___newMTiles_T_3) 
                              >> 4U));
        vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__depthOfCBufferUsed 
            = (0x0000fff0U & (IData)(vlSelfRef.svsimTestbench__DOT__dut__DOT__executor__DOT__unnamedblk1__DOT__unnamedblk4__DOT___newMTiles_T_3));
    }
