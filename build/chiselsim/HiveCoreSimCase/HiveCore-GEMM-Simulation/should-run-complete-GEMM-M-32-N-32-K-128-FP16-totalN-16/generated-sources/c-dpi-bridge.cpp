...
void getBitWidth_io_cmd_payload_regAddr(int* result) {
           svScope prev = setScopeToTestBench();
           getBitWidthImpl_io_cmd_payload_regAddr(result);
           svSetScope(prev);
        }
void getBits_io_cmd_payload_regAddr(svBitVecVal* result) {
           svScope prev = setScopeToTestBench();
           getBitsImpl_io_cmd_payload_regAddr(result);
           svSetScope(prev);
        }
void setBits_io_cmd_payload_regAddr(const svBitVecVal* data) {
           svScope prev = setScopeToTestBench();
           setBitsImpl_io_cmd_payload_regAddr(data);
           svSetScope(prev);
        }
...
int port_setter(int id, int *bitWidth, void (**setter)(const uint8_t*)) {
  switch (id) {
    ...
    case 37: // io_cmd_payload_regAddr
      getBitWidth_io_cmd_payload_regAddr(bitWidth);
      *setter = (void(*)(const uint8_t*))setBits_io_cmd_payload_regAddr;
      return 0;
    case 38: // io_cmd_payload_op
      getBitWidth_io_cmd_payload_op(bitWidth);
