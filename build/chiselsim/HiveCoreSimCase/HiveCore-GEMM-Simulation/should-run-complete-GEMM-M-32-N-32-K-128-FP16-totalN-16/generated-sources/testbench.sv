module svsimTestbench;
  ...
  reg  [$bits(dut.io_cmd_payload_regAddr)-1:0] io_cmd_payload_regAddr = '0;
...
HiveCore dut (
    ...
    .io_cmd_payload_regAddr(io_cmd_payload_regAddr),
  ...
  // Port d: io_dma1Ext_writeData_payload
  ...
  // Port e: io_dma1Ext_writeData_ready
  ...
  // Port f: io_dma1Ext_writeData_valid
  ...
  // Port 10: io_dma1Ext_readData_payload
  ...
  // Port 11: io_dma1Ext_readData_ready
  ...
  // Port 12: io_dma1Ext_readData_valid
  ...
  // Port 18: io_dma0Ext_writeData_payload
  ...
  // Port 19: io_dma0Ext_writeData_ready
  ...
  // Port 1a: io_dma0Ext_writeData_valid
  ...
  // Port 1b: io_dma0Ext_readData_payload
  ...
  // Port 1c: io_dma0Ext_readData_ready
  ...
  // Port 1d: io_dma0Ext_readData_valid
  ...
  // Port 25: io_cmd_payload_regAddr
  export "DPI-C" function getBitWidthImpl_io_cmd_payload_regAddr;
  function void getBitWidthImpl_io_cmd_payload_regAddr;
    output int value;
    value = $bits(dut.io_cmd_payload_regAddr);
  endfunction
  export "DPI-C" function setBitsImpl_io_cmd_payload_regAddr;
  function void setBitsImpl_io_cmd_payload_regAddr;
    input bit [$bits(dut.io_cmd_payload_regAddr)-1:0] value_io_cmd_payload_regAddr;
    io_cmd_payload_regAddr = value_io_cmd_payload_regAddr;
  endfunction
  export "DPI-C" function getBitsImpl_io_cmd_payload_regAddr;
  function void getBitsImpl_io_cmd_payload_regAddr;
    output bit [$bits(dut.io_cmd_payload_regAddr)-1:0] value_io_cmd_payload_regAddr;
    value_io_cmd_payload_regAddr = io_cmd_payload_regAddr;
  endfunction

  // Port 26: io_cmd_payload_op
