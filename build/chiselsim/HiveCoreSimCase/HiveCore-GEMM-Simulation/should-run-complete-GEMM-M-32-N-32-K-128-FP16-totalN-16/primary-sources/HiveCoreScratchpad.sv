...
module HiveCoreScratchpad(	// src/hive/scala/main/HiveCoreScratchpad.scala:12:7
  ...
  StreamFifo aFifo (	// src/hive/scala/main/HiveCoreScratchpad.scala:32:21
    .clock           (clock),
    .reset           (reset),
  ...
  );	// src/hive/scala/main/HiveCoreScratchpad.scala:32:21
  StreamFifo_1 cFifo (	// src/hive/scala/main/HiveCoreScratchpad.scala:33:21
    .clock           (clock),
    .reset           (reset),
  ...
  );	// src/hive/scala/main/HiveCoreScratchpad.scala:33:21
endmodule
