...
VL_ATTR_COLD void VsvsimTestbench_HiveCell___ctor_var_reset(VsvsimTestbench_HiveCell* vlSelf) {
    ...
    vlSelf->io_loadHOut = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13083155452960059857ull);
    vlSelf->io_loadVOut = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16997948601290042064ull);
}
