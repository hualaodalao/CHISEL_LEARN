...
class alignas(VL_CACHE_LINE_BYTES) VsvsimTestbench_HiveWorker final {
  public:
    ...
    CData/*0:0*/ __PVT__io_loadHIn;
    CData/*0:0*/ __PVT__io_loadHOut;
    CData/*0:0*/ __PVT__io_loadVIn;
    CData/*0:0*/ __PVT__io_loadVOut;
    CData/*0:0*/ __PVT__io_validIn;
    CData/*0:0*/ __PVT__io_validOut;
    CData/*1:0*/ __PVT__io_fmtIn;
    CData/*1:0*/ __PVT__io_fmtOut;
    CData/*2:0*/ __PVT__io_rndIn;
    CData/*2:0*/ __PVT__io_rndOut;
    ...
    CData/*7:0*/ __PVT__unnamedblk1__DOT__unnamedblk2__DOT__psumReg_fpResult_eMax;
    ...
    SData/*15:0*/ __PVT__io_aIn;
    SData/*15:0*/ __PVT__io_aOut;
    ...
    SData/*8:0*/ __PVT__unnamedblk1__DOT__unnamedblk2__DOT__product_fpProd_eSum;
    IData/*31:0*/ __PVT__io_psumIn;
    IData/*31:0*/ __PVT__io_psumOut;
