...
VL_ATTR_COLD void VsvsimTestbench_HiveWorker___ctor_var_reset(VsvsimTestbench_HiveWorker* vlSelf) {
    ...
    vlSelf->__PVT__io_loadHOut = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13083155452960059857ull);
    vlSelf->__PVT__io_loadVIn = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4967396123023891649ull);
    vlSelf->__PVT__io_loadVOut = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16997948601290042064ull);
    ...
    vlSelf->__PVT__io_loadVOut_REG = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15761957351109528350ull);
