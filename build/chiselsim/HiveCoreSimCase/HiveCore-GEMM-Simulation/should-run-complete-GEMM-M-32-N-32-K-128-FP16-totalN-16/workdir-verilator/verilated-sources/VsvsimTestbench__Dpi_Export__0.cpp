...
void VsvsimTestbench::getBitWidthImpl_io_cmd_payload_regAddr(int* value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root::getBitWidthImpl_io_cmd_payload_regAddr\n"); );
    // Locals
    IData/*31:0*/ value__Vcvt;
    value__Vcvt = 0;
    // Body
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitWidthImpl_io_cmd_payload_regAddr");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitWidthImpl_io_cmd_payload_regAddr_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitWidthImpl_io_cmd_payload_regAddr_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value__Vcvt);
    *value = value__Vcvt;
}

void VsvsimTestbench::setBitsImpl_io_cmd_payload_regAddr(const svBitVecVal* value_io_cmd_payload_regAddr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root::setBitsImpl_io_cmd_payload_regAddr\n"); );
    // Locals
    CData/*7:0*/ value_io_cmd_payload_regAddr__Vcvt;
    value_io_cmd_payload_regAddr__Vcvt = 0;
    // Body
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("setBitsImpl_io_cmd_payload_regAddr");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_setBitsImpl_io_cmd_payload_regAddr_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_setBitsImpl_io_cmd_payload_regAddr_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    VL_SET_C_SVBV(8, value_io_cmd_payload_regAddr__Vcvt, value_io_cmd_payload_regAddr + 0);
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value_io_cmd_payload_regAddr__Vcvt);
}

void VsvsimTestbench::getBitsImpl_io_cmd_payload_regAddr(svBitVecVal* value_io_cmd_payload_regAddr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root::getBitsImpl_io_cmd_payload_regAddr\n"); );
    // Locals
    CData/*7:0*/ value_io_cmd_payload_regAddr__Vcvt;
    value_io_cmd_payload_regAddr__Vcvt = 0;
    // Body
    static int __Vfuncnum = -1;
    if (VL_UNLIKELY(__Vfuncnum == -1)) {
        __Vfuncnum = Verilated::exportFuncNum("getBitsImpl_io_cmd_payload_regAddr");
    }
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VsvsimTestbench__Vcb_getBitsImpl_io_cmd_payload_regAddr_t __Vcb = reinterpret_cast<VsvsimTestbench__Vcb_getBitsImpl_io_cmd_payload_regAddr_t>(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VsvsimTestbench__Syms*)(__Vscopep->symsp()), value_io_cmd_payload_regAddr__Vcvt);
    VL_SET_SVBV_I(8, value_io_cmd_payload_regAddr, value_io_cmd_payload_regAddr__Vcvt);
}
