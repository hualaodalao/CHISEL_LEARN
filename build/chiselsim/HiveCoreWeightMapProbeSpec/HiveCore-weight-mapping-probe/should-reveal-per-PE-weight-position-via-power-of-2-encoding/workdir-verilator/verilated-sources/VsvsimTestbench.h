...
class alignas(VL_CACHE_LINE_BYTES) VsvsimTestbench VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    static void getBitWidthImpl_io_cmd_payload_reg0Addr(int* value);
    static void getBitWidthImpl_io_cmd_payload_reg1Addr(int* value);
    static void getBitWidthImpl_io_cmd_ready(int* value);
    static void getBitWidthImpl_io_cmd_valid(int* value);
    static void getBitWidthImpl_io_dma0Ext_cmd_payload_addr(int* value);
    static void getBitWidthImpl_io_dma0Ext_cmd_ready(int* value);
    static void getBitWidthImpl_io_dma0Ext_cmd_valid(int* value);
    static void getBitWidthImpl_io_dma0Ext_rsp_payload_data(int* value);
    static void getBitWidthImpl_io_dma0Ext_rsp_payload_rsp(int* value);
    static void getBitWidthImpl_io_dma0Ext_rsp_ready(int* value);
    static void getBitWidthImpl_io_dma0Ext_rsp_valid(int* value);
    ...
    static void getBitWidthImpl_io_dma2Ext_cmd_payload_addr(int* value);
    static void getBitWidthImpl_io_dma2Ext_cmd_ready(int* value);
    static void getBitWidthImpl_io_dma2Ext_cmd_valid(int* value);
    static void getBitWidthImpl_io_dma2Ext_rsp_payload_data(int* value);
    static void getBitWidthImpl_io_dma2Ext_rsp_payload_rsp(int* value);
    static void getBitWidthImpl_io_dma2Ext_rsp_ready(int* value);
    static void getBitWidthImpl_io_dma2Ext_rsp_valid(int* value);
    ...
    static void getBitWidthImpl_io_status_bOccupancy(int* value);
    ...
    static void getBitsImpl_io_cmd_payload_reg0Addr(svBitVecVal* value_io_cmd_payload_reg0Addr);
    static void getBitsImpl_io_cmd_payload_reg1Addr(svBitVecVal* value_io_cmd_payload_reg1Addr);
    ...
    static void getBitsImpl_io_dma0Ext_cmd_payload_addr(svBitVecVal* value_io_dma0Ext_cmd_payload_addr);
    static void getBitsImpl_io_dma0Ext_cmd_ready(svBitVecVal* value_io_dma0Ext_cmd_ready);
    static void getBitsImpl_io_dma0Ext_cmd_valid(svBitVecVal* value_io_dma0Ext_cmd_valid);
    static void getBitsImpl_io_dma0Ext_rsp_payload_data(svBitVecVal* value_io_dma0Ext_rsp_payload_data);
    static void getBitsImpl_io_dma0Ext_rsp_payload_rsp(svBitVecVal* value_io_dma0Ext_rsp_payload_rsp);
    static void getBitsImpl_io_dma0Ext_rsp_ready(svBitVecVal* value_io_dma0Ext_rsp_ready);
    static void getBitsImpl_io_dma0Ext_rsp_valid(svBitVecVal* value_io_dma0Ext_rsp_valid);
    ...
    static void getBitsImpl_io_dma2Ext_cmd_payload_addr(svBitVecVal* value_io_dma2Ext_cmd_payload_addr);
    static void getBitsImpl_io_dma2Ext_cmd_ready(svBitVecVal* value_io_dma2Ext_cmd_ready);
    static void getBitsImpl_io_dma2Ext_cmd_valid(svBitVecVal* value_io_dma2Ext_cmd_valid);
    static void getBitsImpl_io_dma2Ext_rsp_payload_data(svBitVecVal* value_io_dma2Ext_rsp_payload_data);
    static void getBitsImpl_io_dma2Ext_rsp_payload_rsp(svBitVecVal* value_io_dma2Ext_rsp_payload_rsp);
    static void getBitsImpl_io_dma2Ext_rsp_ready(svBitVecVal* value_io_dma2Ext_rsp_ready);
    static void getBitsImpl_io_dma2Ext_rsp_valid(svBitVecVal* value_io_dma2Ext_rsp_valid);
    ...
    static void getBitsImpl_io_status_bOccupancy(svBitVecVal* value_io_status_bOccupancy);
    ...
    static void setBitsImpl_io_cmd_payload_reg0Addr(const svBitVecVal* value_io_cmd_payload_reg0Addr);
    static void setBitsImpl_io_cmd_payload_reg1Addr(const svBitVecVal* value_io_cmd_payload_reg1Addr);
    static void setBitsImpl_io_cmd_valid(const svBitVecVal* value_io_cmd_valid);
    static void setBitsImpl_io_dma0Ext_cmd_ready(const svBitVecVal* value_io_dma0Ext_cmd_ready);
    static void setBitsImpl_io_dma0Ext_rsp_payload_data(const svBitVecVal* value_io_dma0Ext_rsp_payload_data);
    static void setBitsImpl_io_dma0Ext_rsp_payload_rsp(const svBitVecVal* value_io_dma0Ext_rsp_payload_rsp);
    static void setBitsImpl_io_dma0Ext_rsp_valid(const svBitVecVal* value_io_dma0Ext_rsp_valid);
    ...
    static void setBitsImpl_io_dma2Ext_cmd_ready(const svBitVecVal* value_io_dma2Ext_cmd_ready);
    static void setBitsImpl_io_dma2Ext_rsp_payload_data(const svBitVecVal* value_io_dma2Ext_rsp_payload_data);
    static void setBitsImpl_io_dma2Ext_rsp_payload_rsp(const svBitVecVal* value_io_dma2Ext_rsp_payload_rsp);
    static void setBitsImpl_io_dma2Ext_rsp_valid(const svBitVecVal* value_io_dma2Ext_rsp_valid);
