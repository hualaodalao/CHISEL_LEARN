...
void VsvsimTestbench___024root___act_sequent__TOP__0(VsvsimTestbench___024root* vlSelf) {
    ...
    if ((1U == vlSelfRef.svsimTestbench__DOT__simulationState)) {
        VsvsimTestbench___024root____Vdpiimwrap_svsimTestbench__DOT__simulation_body_TOP(
                                                                                ...
                                                                                "/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreWeightMapProbeSpec/HiveCore-weight-mapping-probe/should-reveal-per-PE-weight-position-via-power-of-2-encoding/workdir-verilator/../generated-sources/testbench.sv", 0x00000335U);
...
void VsvsimTestbench___024root___eval(VsvsimTestbench___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00002710U < __VicoIterCount)))) {
            ...
            VsvsimTestbench___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/Users/wangliutailong/Qoder_Proj/Chisel_Learn/build/chiselsim/HiveCoreWeightMapProbeSpec/HiveCore-weight-mapping-probe/should-reveal-per-PE-weight-position-via-power-of-2-encoding/workdir-verilator/../generated-sources/testbench.sv", 1, "", "DIDNOTCONVERGE: Input combinational region did not converge after '--converge-limit' of 10000 tries");
        }
