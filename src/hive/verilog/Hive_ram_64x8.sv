...
module Hive_ram_64x8(	// src/main/scala/chisel3/util/Queue.scala:73:91
  input  [5:0] R0_addr,
  input        R0_en,
               R0_clk,
  output [7:0] R0_data,
  ...
  reg [7:0] Memory[0:63];	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:91
        for (logic [6:0] i = 7'h0; i < 7'h40; i += 7'h1) begin
          ...
          Memory[i[5:0]] = _RANDOM_MEM[7:0];	// src/main/scala/chisel3/util/Queue.scala:73:91
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
