...
module Hive_HiveCoreExecutor_Verification_Assert();	// src/hive/scala/main/HiveCoreExecutor.scala:243:15
  `ifndef SYNTHESIS	// src/hive/scala/main/HiveCoreExecutor.scala:199:13
    always @(posedge Hive_HiveCoreExecutor.clock) begin	// src/hive/scala/main/HiveCoreExecutor.scala:30:7, :199:13
      if (Hive_HiveCoreExecutor._layerCapture & Hive_HiveCoreExecutor._layerCapture_0
          & ~Hive_HiveCoreExecutor.reset & ~Hive_HiveCoreExecutor.io_cPush_ready) begin	// src/hive/scala/main/HiveCoreExecutor.scala:30:7, :32:14, :188:29, :190:{19,31}, :199:13
      ...
      if (Hive_HiveCoreExecutor._layerCapture_1 & Hive_HiveCoreExecutor.io_execute
          & ~Hive_HiveCoreExecutor.reset & (|Hive_HiveCoreExecutor.io_aOccupancy)) begin	// src/hive/scala/main/HiveCoreExecutor.scala:30:7, :32:14, :199:13, :214:17, :218:24, :243:{15,30}
