/** SpinalHDL spinal.lib.bus.regif.Doc.Template（HtmlTemplate）的 Chisel 移植版。
  * 纯字符串模板，除去掉 package 声明外与源码一致。
  */
...
object HtmlTemplate {
  ...
  def getHTML(moduleName: String, tbody: String, hasBlock: Boolean = false): String = s"""
       ...
       |  </div>
       |  <footer>
       |  <div> <p class="info">Powered by <a href="https://spinalhdl.github.io/SpinalDoc-RTD/"> SpinalHDL </a> RegIf (Chisel port) </p> </div>
